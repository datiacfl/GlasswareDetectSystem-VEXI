...
**
** Created: Tue Jun 26 15:44:04 2018
...
static const char qt_meta_stringdata_WidgetTitle[] = {
    "WidgetTitle\0\0showSkin()\0showMin()\0"
    "showMainMenu()\0closeWidget()\0current_page\0"
    "turnPage(int)\0turnPage(QString)\0"
};
...
// SIGNAL 0
void WidgetTitle::showSkin()
{
    QMetaObject::activate(this, &staticMetaObject, 0, 0);
}

// SIGNAL 1
void WidgetTitle::showMin()
{
    QMetaObject::activate(this, &staticMetaObject, 1, 0);
}

// SIGNAL 2
void WidgetTitle::showMainMenu()
{
    QMetaObject::activate(this, &staticMetaObject, 2, 0);
}

// SIGNAL 3
void WidgetTitle::closeWidget()
{
