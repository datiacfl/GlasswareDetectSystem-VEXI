...
**
** Created: Tue Jun 26 15:44:09 2018
...
static const char qt_meta_stringdata_myTableView[] = {
    "myTableView\0\0signal_dragMove()\0"
};
...
void myTableView::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        switch (_id) {
        case 0: _t->signal_dragMove(); break;
        default: ;
        }
    }
    Q_UNUSED(_a);
...
const QMetaObjectExtraData myTableView::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject myTableView::staticMetaObject = {
    { &QTableView::staticMetaObject, qt_meta_stringdata_myTableView,
      qt_meta_data_myTableView, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &myTableView::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_myTableView))
...
// SIGNAL 0
void myTableView::signal_dragMove()
{
