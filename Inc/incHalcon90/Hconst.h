...
#define H_ERR_PTHRD_SCHED  2989 /* Scheduler call failed.*/
...
#define H_ERR_BAR_WRONGCODE  8708 /* Wrong bar code */
...
#define H_ERR_MAT_UNCHAR   9216 /* Matrix file: Unvalid character */
...
#define TEXT_LANGUAGES            {"german", "english", ""}
#define MAX_PROG_LANG             40
#define PROG_LANGUAGES            {"trias", "c", "c++", "c#", "vb.net"}
...
#define MAX_CHECK        11       /* Number of possible checks */
...
#define CHECK_MEMORY     (1<<10) /* memory statistics and overwritten borders*/
#define DEF_CHECK        (CHECK_NONE | CHECK_GIVE_ERROR | CHECK_DB)
...
#define DEF_XPACKAGE               (128*1024) /* Transfer to X-Server        */
...
#define DEF_VECT_STEP              8         /* set_paint('vector_field')    */
#define DEF_VECT_MIN_LENGTH        1         /* set_paint('vector_field')    */
#define DEF_VECT_SCALE             2         /* set_paint('vector_field')    */
...
#define DEF_TIMEOUT_GRANULARITY    0.5    /* set_system('timeout_granularity */
