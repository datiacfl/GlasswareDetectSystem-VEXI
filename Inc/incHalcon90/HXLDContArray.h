...
public:
  ...
  virtual HXLDContArray RadialDistortionSelfCalibration(const Halcon::HTuple &Width, const Halcon::HTuple &Height, const Halcon::HTuple &InlierThreshold, const Halcon::HTuple &RandSeed, const Halcon::HTuple &DistortionModel, const Halcon::HTuple &DistortionCenter, const Halcon::HTuple &PrincipalPointVar, Halcon::HTuple *CamParam) const;
  // Calibrate the radial distortion.
  virtual HXLDContArray RadialDistortionSelfCalibration(Hlong Width, Hlong Height, double InlierThreshold, Hlong RandSeed, const char *DistortionModel, const char *DistortionCenter, double PrincipalPointVar, Halcon::HTuple *CamParam) const;
  // Transform an XLD contour into the plane z=0 of a world coordinate system.
  virtual HXLDContArray ContourToWorldPlaneXld(const Halcon::HTuple &CamParam, const Halcon::HTuple &WorldPose, const Halcon::HTuple &Scale) const;
