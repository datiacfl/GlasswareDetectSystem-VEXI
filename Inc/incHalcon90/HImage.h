...
public:
  ...
  virtual HTuple FindCalibDescriptorModel(const Halcon::HDescriptorModel &ModelID, const Halcon::HTuple &DetectorParamName, const Halcon::HTuple &DetectorParamValue, const Halcon::HTuple &DescriptorParamName, const Halcon::HTuple &DescriptorParamValue, const Halcon::HTuple &Seed, const Halcon::HTuple &MinScore, const Halcon::HTuple &NumMatches, const Halcon::HTuple &CamParam, const Halcon::HTuple &ScoreType, Halcon::HTuple *Score) const;
  // Find the best matches of a descriptor model in an image.
  virtual HTuple FindUncalibDescriptorModel(const Halcon::HDescriptorModel &ModelID, const Halcon::HTuple &DetectorParamName, const Halcon::HTuple &DetectorParamValue, const Halcon::HTuple &DescriptorParamName, const Halcon::HTuple &DescriptorParamValue, const Halcon::HTuple &Seed, const Halcon::HTuple &MinScore, const Halcon::HTuple &NumMatches, const Halcon::HTuple &ScoreType, Halcon::HTuple *Score) const;
  ...
  virtual HImage ApplyColorTransLut(const HImage &Image2, const HImage &Image3, HImage *ImageResult2, HImage *ImageResult3, const Halcon::HColorTransLUT &LUTHandle) const;
  // Color space transformation using pre-generated look-up-table.
  virtual HImage ApplyColorTransLut(const HImageArray &Image2, const HImageArray &Image3, HImage *ImageResult2, HImage *ImageResult3, const Halcon::HColorTransLUT &LUTHandle) const;
  ...
  static HImage GenRadialDistortionMap(const Halcon::HTuple &CamParamIn, const Halcon::HTuple &CamParamOut, const Halcon::HTuple &Interpolation);
