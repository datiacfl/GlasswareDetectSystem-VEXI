...
private:
  HDCoord    x, y;
public:
  HDPoint2D(HDCoord X, HDCoord Y): x(X), y(Y) {}
  HDPoint2D(int X=0, int Y=0): x(X), y(Y) {}
  HDPoint2D(const HDPoint2D &p): x(p.x), y(p.y) {}
...
private:
  HDCoord    x, y, z;
public:
  HDPoint3D(HDCoord X, HDCoord Y, HDCoord Z): x(X), y(Y), z(Z) {}
  HDPoint3D(int X=0, int Y=0, int Z=0): x(X), y(Y), z(Z) {}
  HDPoint3D(const HDPoint3D &p): x(p.x), y(p.y), z(p.z) {}
...
private:
  HDCoord    x, y;
public:
  HDVector2D(HDCoord X, HDCoord Y): x(X), y(Y) {}
  HDVector2D(int X=0, int Y=0): x(X), y(Y) {}
  HDVector2D(const HDVector2D &p): x(p.x), y(p.y) {}
...
private:
  HDCoord    x, y, z;
public:
  HDVector3D(HDCoord X, HDCoord Y, HDCoord Z): x(X), y(Y), z(Z) {}
  HDVector3D(int X=0, int Y=0, int Z=0): x(X), y(Y), z(Z) {}
  HDVector3D(const HDVector3D &p): x(p.x), y(p.y), z(p.z) {}
...
public:
   ...
   HPoint2D(HCoord X, HCoord Y): x((loat)X), y((loat)Y) {}
#endif
  HPoint2D(double X=0.0, double Y=0.0): x((float)X), y((float)Y) {}
  HPoint2D(const HPoint2D &p): x(p.x), y(p.y) {}
...
public:
  ...
  HPoint3D(const HPoint3D &p): x(p.x), y(p.y), z(p.z) {}
...
public:
  ...
  HVector2D(const HVector2D &p): x(p.x), y(p.y) {}
...
public:
  ...
  HVector3D(const HVector3D &p): x(p.x), y(p.y), z(p.z) {}
...
public:
  ...
  HLine2D(const HLine2D &line): start(line.start), end(line.end) {}
...
public:
  ...
  HLine3D(const HLine3D &line): start(line.start), end(line.end) {}
