...
#define     HALCON_C_VERS             "9.0"
#define     HALCON_C_LAST_UPDATE      "09.12.2008"
...
/* obsolete method, kept inside for kompatiblity reasons, returns always 0
 *---------------------------------------------------------------------------*/
...
#if !defined(H_NO_INLINE) && !defined(__cplusplus) && !defined(H_INLINE)
#define H_NO_INLINE
#endif
