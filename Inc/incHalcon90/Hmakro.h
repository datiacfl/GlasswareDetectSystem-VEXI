...
# define HFreeGeneral(PROC_HANDLE,VOID_PTR)                     \
  HXFreeGeneral(PROC_HANDLE,VOID_PTR,"",(INT4_8)-1)
#else
# define HFreeGeneral(PROC_HANDLE,VOID_PTR,SIZE,NEW_PTR)            \
  HXFreeGeneral(PROC_HANDLE,VOID_PTR,__FILE__,(INT4_8)__LINE__)
#endif

#ifdef SMALL
# define HReallocGeneral(PROC_HANDLE,VOID_PTR,SIZE,NEW_PTR)     \
  HXReallocGeneral(PROC_HANDLE,VOID_PTR,SIZE,(NEW_PTR),"",(INT4_8)-1)
#else
# define HReallocGeneral(PROC_HANDLE,VOID_PTR,SIZE,NEW_PTR)       \
  HXReallocGeneral(PROC_HANDLE,VOID_PTR,SIZE,(NEW_PTR),__FILE__,  \
                   (INT4_8)__LINE__)
#endif

#ifdef SMALL
# define HFreeRLGeneral(PROC_HANDLE,REGION)         \
  HXFreeRLGeneral(PROC_HANDLE,REGION,"",(INT4_8)-1)
#else
# define HFreeRLGeneral(PROC_HANDLE,REGION,SIZE,NEW_PTR)      \
  HXFreeGeneral(PROC_HANDLE,REGION,__FILE__,(INT4_8)__LINE__)
#endif

#ifdef SMALL
# define HReallocRLNumGeneral(PROC_HANDLE,REGION,SIZE,NEW_REGION)       \
  HXReallocRLNumGeneral(PROC_HANDLE,REGION,SIZE,(NEW_REGION),"",(INT4_8)-1)
#else
# define HReallocRLNumGeneral(PROC_HANDLE,REGION,SIZE,NEW_REGION)       \
  HXReallocRLNumGeneral(PROC_HANDLE,REGION,SIZE,(NEW_REGION),__FILE__,  \
                        (INT4_8)__LINE__)
#endif
...
# define HReallocToGlobal(PROC_HANDLE,VOID_PTR,SIZE,NEW_PTR)            \
  HXReallocToGlobal(PROC_HANDLE,VOID_PTR,SIZE,(NEW_PTR),"",(INT4_8)-1)
#else
# define HReallocToGlobal(PROC_HANDLE,VOID_PTR,SIZE,NEW_PTR)      \
  HXReallocToGlobal(PROC_HANDLE,VOID_PTR,SIZE,(NEW_PTR),__FILE__, \
                    (INT4_8)__LINE__)
#endif
...
# define HReallocRLNumToGlobal(PROC_HANDLE,REGION,SIZE,NEW_REGION)      \
  HXReallocRLNumToGlobal(PROC_HANDLE,REGION,SIZE,NEW_REGION,"",(INT4_8)-1)
#else
# define HReallocRLNumToGlobal(PROC_HANDLE,REGION,SIZE,NEW_REGION)    \
  HXReallocRLNumToGlobal(PROC_HANDLE,REGION,SIZE,NEW_REGION,__FILE__, \
                         (INT4_8)__LINE__)
#endif
