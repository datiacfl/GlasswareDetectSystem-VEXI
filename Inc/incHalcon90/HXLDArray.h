...
public:
  ...
  // projection
  virtual HTuple GetRectanglePose(const Halcon::HTuple &CamParam, const Halcon::HTuple &Width, const Halcon::HTuple &Height, const Halcon::HTuple &WeightingMode, const Halcon::HTuple &ClippingFactor, Halcon::HTuple *CovPose, Halcon::HTuple *Error) const;
