...
public:
  ...
  virtual HImageArray ApplyColorTransLut(const HImageArray &Image2, const HImageArray &Image3, HImageArray *ImageResult2, HImageArray *ImageResult3, const Halcon::HColorTransLUT &LUTHandle) const;
