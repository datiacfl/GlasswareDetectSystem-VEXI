/***********************************************************
 * File generated by the HALCON-Compiler hcomp version 9.0
...
#define H_SYSTEM_PROC_NUMBER 1482
#endif
...
LIntExport Herror find_calib_descriptor_model(const Halcon::Hobject &Image, const Halcon::HTuple &ModelID, const Halcon::HTuple &DetectorParamName, const Halcon::HTuple &DetectorParamValue, const Halcon::HTuple &DescriptorParamName, const Halcon::HTuple &DescriptorParamValue, const Halcon::HTuple &Seed, const Halcon::HTuple &MinScore, const Halcon::HTuple &NumMatches, const Halcon::HTuple &CamParam, const Halcon::HTuple &ScoreType, Halcon::HTuple *Pose, Halcon::HTuple *Score);
LIntExport Herror find_uncalib_descriptor_model(const Halcon::Hobject &Image, const Halcon::HTuple &ModelID, const Halcon::HTuple &DetectorParamName, const Halcon::HTuple &DetectorParamValue, const Halcon::HTuple &DescriptorParamName, const Halcon::HTuple &DescriptorParamValue, const Halcon::HTuple &Seed, const Halcon::HTuple &MinScore, const Halcon::HTuple &NumMatches, const Halcon::HTuple &ScoreType, Halcon::HTuple *HomMat2D, Halcon::HTuple *Score);
...
LIntExport Herror gen_bundle_adjusted_mosaic(const Halcon::Hobject &Images, Halcon::Hobject *MosaicImage, const Halcon::HTuple &HomMatrices2D, const Halcon::HTuple &StackingOrder, const Halcon::HTuple &TransformRegion, Halcon::HTuple *TransMat2D);
LIntExport Herror gen_projective_mosaic(const Halcon::Hobject &Images, Halcon::Hobject *MosaicImage, const Halcon::HTuple &StartImage, const Halcon::HTuple &MappingSource, const Halcon::HTuple &MappingDest, const Halcon::HTuple &HomMatrices2D, const Halcon::HTuple &StackingOrder, const Halcon::HTuple &TransformRegion, Halcon::HTuple *MosaicMatrices2D);
LIntExport Herror projective_trans_image_size(const Halcon::Hobject &Image, Halcon::Hobject *TransImage, const Halcon::HTuple &HomMat2D, const Halcon::HTuple &Interpolation, const Halcon::HTuple &Width, const Halcon::HTuple &Height, const Halcon::HTuple &TransformRegion);
LIntExport Herror projective_trans_image(const Halcon::Hobject &Image, Halcon::Hobject *TransImage, const Halcon::HTuple &HomMat2D, const Halcon::HTuple &Interpolation, const Halcon::HTuple &AdaptImageSize, const Halcon::HTuple &TransformRegion);
...
LIntExport Herror clear_color_trans_lut(const Halcon::HTuple &LUTHandle);
LIntExport Herror clear_color_trans_lut(Hlong LUTHandle);
LIntExport Herror apply_color_trans_lut(const Halcon::Hobject &Image1, const Halcon::Hobject &Image2, const Halcon::Hobject &Image3, Halcon::Hobject *ImageResult1, Halcon::Hobject *ImageResult2, Halcon::Hobject *ImageResult3, const Halcon::HTuple &LUTHandle);
LIntExport Herror apply_color_trans_lut(const Halcon::Hobject &Image1, const Halcon::Hobject &Image2, const Halcon::Hobject &Image3,Halcon::Hobject *ImageResult1,Halcon::Hobject *ImageResult2,Halcon::Hobject *ImageResult3, Hlong LUTHandle);
LIntExport Herror create_color_trans_lut(const Halcon::HTuple &ColorSpace, const Halcon::HTuple &TransDirection, const Halcon::HTuple &NumBits, Halcon::HTuple *LUTHandle);
LIntExport Herror create_color_trans_lut(const Halcon::HTuple &ColorSpace, const Halcon::HTuple &TransDirection, const Halcon::HTuple &NumBits, Hlong *LUTHandle);
LIntExport Herror create_color_trans_lut(const char *ColorSpace, const char *TransDirection, Hlong NumBits, Halcon::HTuple *LUTHandle);
LIntExport Herror create_color_trans_lut(const char *ColorSpace, const char *TransDirection, Hlong NumBits, Hlong *LUTHandle);
...
LIntExport Herror lines_gauss(const Halcon::Hobject &Image, Halcon::Hobject *Lines, const Halcon::HTuple &Sigma, const Halcon::HTuple &Low, const Halcon::HTuple &High, const Halcon::HTuple &LightDark, const Halcon::HTuple &ExtractWidth, const Halcon::HTuple &CorrectPositions, const Halcon::HTuple &CompleteJunctions);
LIntExport Herror lines_gauss(const Halcon::Hobject &Image,Halcon::Hobject *Lines, double Sigma, double Low, double High, const char *LightDark, const char *ExtractWidth, const char *CorrectPositions, const char *CompleteJunctions);
...
LIntExport Herror points_harris_binomial(const Halcon::Hobject &Image, const Halcon::HTuple &MaskSizeGrd, const Halcon::HTuple &MaskSizeSmooth, const Halcon::HTuple &Alpha, const Halcon::HTuple &Threshold, const Halcon::HTuple &Subpix, Halcon::HTuple *Row, Halcon::HTuple *Column);
LIntExport Herror points_harris_binomial(const Halcon::Hobject &Image, Hlong MaskSizeGrd, Hlong MaskSizeSmooth, double Alpha, double Threshold, const char *Subpix, Halcon::HTuple *Row, Halcon::HTuple *Column);
...
LIntExport Herror real_to_vector_field(const Halcon::Hobject &Row, const Halcon::Hobject &Col, Halcon::Hobject *VectorField);
...
LIntExport Herror connect_grid_points(const Halcon::Hobject &Image, Halcon::Hobject *ConnectingLines, const Halcon::HTuple &Row, const Halcon::HTuple &Col, const Halcon::HTuple &Sigma, const Halcon::HTuple &MaxDist);
LIntExport Herror gen_grid_rectification_map(const Halcon::Hobject &Image, const Halcon::Hobject &ConnectingLines, Halcon::Hobject *Map, Halcon::Hobject *Meshes, const Halcon::HTuple &GridSpacing, const Halcon::HTuple &Rotation, const Halcon::HTuple &Row, const Halcon::HTuple &Col);
LIntExport Herror gen_arbitrary_distortion_map(Halcon::Hobject *Map, const Halcon::HTuple &GridSpacing, const Halcon::HTuple &Row, const Halcon::HTuple &Col, const Halcon::HTuple &GridWidth, const Halcon::HTuple &ImageWidth, const Halcon::HTuple &ImageHeight);
...
LIntExport Herror descript_class_box(const Halcon::HTuple &ClassifHandle, const Halcon::HTuple &Dimensions);
...
LIntExport Herror radial_distortion_self_calibration(const Halcon::Hobject &Contours, Halcon::Hobject *SelectedContours, const Halcon::HTuple &Width, const Halcon::HTuple &Height, const Halcon::HTuple &InlierThreshold, const Halcon::HTuple &RandSeed, const Halcon::HTuple &DistortionModel, const Halcon::HTuple &DistortionCenter, const Halcon::HTuple &PrincipalPointVar, Halcon::HTuple *CamParam);
LIntExport Herror radial_distortion_self_calibration(const Halcon::Hobject &Contours,Halcon::Hobject *SelectedContours, Hlong Width, Hlong Height, double InlierThreshold, Hlong RandSeed, const char *DistortionModel, const char *DistortionCenter, double PrincipalPointVar, Halcon::HTuple *CamParam);
LIntExport Herror cam_par_to_cam_mat(const Halcon::HTuple &CamParam, Halcon::HTuple *CameraMatrix, Halcon::HTuple *ImageWidth, Halcon::HTuple *ImageHeight);
LIntExport Herror cam_mat_to_cam_par(const Halcon::HTuple &CameraMatrix, const Halcon::HTuple &Kappa, const Halcon::HTuple &ImageWidth, const Halcon::HTuple &ImageHeight, Halcon::HTuple *CamParam);
...
LIntExport Herror get_rectangle_pose(const Halcon::Hobject &Contour, const Halcon::HTuple &CamParam, const Halcon::HTuple &Width, const Halcon::HTuple &Height, const Halcon::HTuple &WeightingMode, const Halcon::HTuple &ClippingFactor, Halcon::HTuple *Pose, Halcon::HTuple *CovPose, Halcon::HTuple *Error);
LIntExport Herror get_circle_pose(const Halcon::Hobject &Contour, const Halcon::HTuple &CamParam, const Halcon::HTuple &Radius, const Halcon::HTuple &OutputType, Halcon::HTuple *Pose1, Halcon::HTuple *Pose2);
...
LIntExport Herror gen_radial_distortion_map(Halcon::Hobject *Map, const Halcon::HTuple &CamParamIn, const Halcon::HTuple &CamParamOut, const Halcon::HTuple &Interpolation);
LIntExport Herror gen_image_to_world_plane_map(Halcon::Hobject *Map, const Halcon::HTuple &CamParam, const Halcon::HTuple &WorldPose, const Halcon::HTuple &WidthIn, const Halcon::HTuple &HeightIn, const Halcon::HTuple &WidthMapped, const Halcon::HTuple &HeightMapped, const Halcon::HTuple &Scale, const Halcon::HTuple &Interpolation);
LIntExport Herror image_to_world_plane(const Halcon::Hobject &Image, Halcon::Hobject *ImageWorld, const Halcon::HTuple &CamParam, const Halcon::HTuple &WorldPose, const Halcon::HTuple &Width, const Halcon::HTuple &Height, const Halcon::HTuple &Scale, const Halcon::HTuple &Interpolation);
LIntExport Herror contour_to_world_plane_xld(const Halcon::Hobject &Contours, Halcon::Hobject *ContoursTrans, const Halcon::HTuple &CamParam, const Halcon::HTuple &WorldPose, const Halcon::HTuple &Scale);
LIntExport Herror image_points_to_world_plane(const Halcon::HTuple &CamParam, const Halcon::HTuple &WorldPose, const Halcon::HTuple &Rows, const Halcon::HTuple &Cols, const Halcon::HTuple &Scale, Halcon::HTuple *X, Halcon::HTuple *Y);
...
LIntExport Herror get_line_of_sight(const Halcon::HTuple &Row, const Halcon::HTuple &Column, const Halcon::HTuple &CamParam, Halcon::HTuple *PX, Halcon::HTuple *PY, Halcon::HTuple *PZ, Halcon::HTuple *QX, Halcon::HTuple *QY, Halcon::HTuple *QZ);
LIntExport Herror project_3d_point(const Halcon::HTuple &X, const Halcon::HTuple &Y, const Halcon::HTuple &Z, const Halcon::HTuple &CamParam, Halcon::HTuple *Row, Halcon::HTuple *Column);
...
LIntExport Herror read_cam_par(const Halcon::HTuple &CamParFile, Halcon::HTuple *CamParam);
LIntExport Herror read_cam_par(const char *CamParFile, Halcon::HTuple *CamParam);
LIntExport Herror write_cam_par(const Halcon::HTuple &CamParam, const Halcon::HTuple &CamParFile);
LIntExport Herror sim_caltab(Halcon::Hobject *SimImage, const Halcon::HTuple &CalTabDescrFile, const Halcon::HTuple &CamParam, const Halcon::HTuple &CaltabPose, const Halcon::HTuple &GrayBackground, const Halcon::HTuple &GrayCaltab, const Halcon::HTuple &GrayMarks, const Halcon::HTuple &ScaleFac);
LIntExport Herror disp_caltab(const Halcon::HTuple &WindowHandle, const Halcon::HTuple &CalTabDescrFile, const Halcon::HTuple &CamParam, const Halcon::HTuple &CaltabPose, const Halcon::HTuple &ScaleFac);
LIntExport Herror camera_calibration(const Halcon::HTuple &NX, const Halcon::HTuple &NY, const Halcon::HTuple &NZ, const Halcon::HTuple &NRow, const Halcon::HTuple &NCol, const Halcon::HTuple &StartCamParam, const Halcon::HTuple &NStartPose, const Halcon::HTuple &EstimateParams, Halcon::HTuple *CamParam, Halcon::HTuple *NFinalPose, Halcon::HTuple *Errors);
...
LIntExport Herror get_object_model_3d_params(const Halcon::HTuple &ObjectModel3DID, const Halcon::HTuple &GenParamNames, Halcon::HTuple *GenParamValues);
LIntExport Herror get_object_model_3d_params(const Halcon::HTuple &ObjectModel3DID, const Halcon::HTuple &GenParamNames, char *GenParamValues);
LIntExport Herror get_object_model_3d_params(Hlong ObjectModel3DID, const char *GenParamNames, Halcon::HTuple *GenParamValues);
LIntExport Herror get_object_model_3d_params(Hlong ObjectModel3DID, const char *GenParamNames, char *GenParamValues);
LIntExport Herror project_object_model_3d(Halcon::Hobject *ModelContours, const Halcon::HTuple &ObjectModel3DID, const Halcon::HTuple &CamParam, const Halcon::HTuple &Pose, const Halcon::HTuple &HiddenSurfaceRemoval, const Halcon::HTuple &MinFaceAngle);
LIntExport Herror affine_trans_object_model_3d(const Halcon::HTuple &ObjectModel3DID, const Halcon::HTuple &HomMat3D, Halcon::HTuple *ObjectModel3DIDAffineTrans);
LIntExport Herror affine_trans_object_model_3d(const Halcon::HTuple &ObjectModel3DID, const Halcon::HTuple &HomMat3D, Hlong *ObjectModel3DIDAffineTrans);
LIntExport Herror clear_all_object_model_3d(void);
LIntExport Herror clear_object_model_3d(const Halcon::HTuple &ObjectModel3DID);
LIntExport Herror clear_object_model_3d(Hlong ObjectModel3DID);
LIntExport Herror read_object_model_3d_dxf(const Halcon::HTuple &FileName, const Halcon::HTuple &Scale, const Halcon::HTuple &GenParamNames, const Halcon::HTuple &GenParamValues, Halcon::HTuple *ObjectModel3DID, Halcon::HTuple *DxfStatus);
LIntExport Herror read_object_model_3d_dxf(const Halcon::HTuple &FileName, const Halcon::HTuple &Scale, const Halcon::HTuple &GenParamNames, const Halcon::HTuple &GenParamValues, Hlong *ObjectModel3DID, char *DxfStatus);
...
LIntExport Herror approx_chain_simple(Hlong Row, Hlong Column, Halcon::HTuple *ArcCenterRow, Halcon::HTuple *ArcCenterCol, Halcon::HTuple *ArcAngle, Halcon::HTuple *ArcBeginRow, Halcon::HTuple *ArcBeginCol, Halcon::HTuple *LineBeginRow, Halcon::HTuple *LineBeginCol, Halcon::HTuple *LineEndRow, Halcon::HTuple *LineEndCol, Halcon::HTuple *Order);
...
LIntExport Herror approx_chain(Hlong Row, Hlong Column, double MinWidthCoord, double MaxWidthCoord, double ThreshStart, double ThreshEnd, double ThreshStep, double MinWidthSmooth, double MaxWidthSmooth, Hlong MinWidthCurve, Hlong MaxWidthCurve, double Weight1, double Weight2, double Weight3, Halcon::HTuple *ArcCenterRow, Halcon::HTuple *ArcCenterCol, Halcon::HTuple *ArcAngle, Halcon::HTuple *ArcBeginRow, Halcon::HTuple *ArcBeginCol, Halcon::HTuple *LineBeginRow, Halcon::HTuple *LineBeginCol, Halcon::HTuple *LineEndRow, Halcon::HTuple *LineEndCol, Halcon::HTuple *Order);
...
LIntExport Herror trainf_ocr_class_box(const Halcon::HTuple &OcrHandle, const Halcon::HTuple &FileName, Halcon::HTuple *AvgConfidence);
LIntExport Herror trainf_ocr_class_box(const Halcon::HTuple &OcrHandle, const Halcon::HTuple &FileName, double *AvgConfidence);
LIntExport Herror trainf_ocr_class_box(Hlong OcrHandle, const char *FileName, Halcon::HTuple *AvgConfidence);
LIntExport Herror trainf_ocr_class_box(Hlong OcrHandle, const char *FileName, double *AvgConfidence);
LIntExport Herror write_ocr_trainf(const Halcon::Hobject &Character, const Halcon::Hobject &Image, const Halcon::HTuple &Class, const Halcon::HTuple &FileName);
LIntExport Herror write_ocr_trainf(const Halcon::Hobject &Character, const Halcon::Hobject &Image, const char *Class, const char *FileName);
...
LIntExport Herror write_ocr_trainf_image(const Halcon::Hobject &Character, const Halcon::HTuple &Class, const Halcon::HTuple &FileName);
LIntExport Herror write_ocr_trainf_image(const Halcon::Hobject &Character, const char *Class, const char *FileName);
LIntExport Herror append_ocr_trainf(const Halcon::Hobject &Character, const Halcon::Hobject &Image, const Halcon::HTuple &Class, const Halcon::HTuple &FileName);
LIntExport Herror append_ocr_trainf(const Halcon::Hobject &Character, const Halcon::Hobject &Image, const char *Class, const char *FileName);
LIntExport Herror read_ocr_trainf_names(const Halcon::HTuple &TrainFileNames, Halcon::HTuple *CharacterNames, Halcon::HTuple *CharacterCount);
LIntExport Herror read_ocr_trainf_names(const Halcon::HTuple &TrainFileNames, char *CharacterNames, Hlong *CharacterCount);
LIntExport Herror read_ocr_trainf_names(const char *TrainFileNames, Halcon::HTuple *CharacterNames, Halcon::HTuple *CharacterCount);
LIntExport Herror read_ocr_trainf_names(const char *TrainFileNames, char *CharacterNames, Hlong *CharacterCount);
LIntExport Herror read_ocr_trainf_select(Halcon::Hobject *Characters, const Halcon::HTuple &TrainFileNames, const Halcon::HTuple &SearchNames, Halcon::HTuple *FoundNames);
LIntExport Herror read_ocr_trainf_select(Halcon::Hobject *Characters, const Halcon::HTuple &TrainFileNames, const Halcon::HTuple &SearchNames, char *FoundNames);
LIntExport Herror read_ocr_trainf_select(Halcon::Hobject *Characters, const char *TrainFileNames, const char *SearchNames, Halcon::HTuple *FoundNames);
LIntExport Herror read_ocr_trainf_select(Halcon::Hobject *Characters, const char *TrainFileNames, const char *SearchNames, char *FoundNames);
LIntExport Herror read_ocr_trainf(Halcon::Hobject *Characters, const Halcon::HTuple &TrainFileNames, Halcon::HTuple *CharacterNames);
LIntExport Herror read_ocr_trainf(Halcon::Hobject *Characters, const char *TrainFileNames, Halcon::HTuple *CharacterNames);
...
LIntExport Herror open_socket_connect(const Halcon::HTuple &HostName, const Halcon::HTuple &Port, Halcon::HTuple *Socket);
LIntExport Herror open_socket_connect(const Halcon::HTuple &HostName, const Halcon::HTuple &Port, Hlong *Socket);
LIntExport Herror open_socket_connect(const char *HostName, Hlong Port, Halcon::HTuple *Socket);
LIntExport Herror open_socket_connect(const char *HostName, Hlong Port, Hlong *Socket);
LIntExport Herror open_socket_accept(const Halcon::HTuple &Port, Halcon::HTuple *AcceptingSocket);
LIntExport Herror open_socket_accept(const Halcon::HTuple &Port, Hlong *AcceptingSocket);
LIntExport Herror open_socket_accept(Hlong Port, Halcon::HTuple *AcceptingSocket);
LIntExport Herror open_socket_accept(Hlong Port, Hlong *AcceptingSocket);
...
LIntExport Herror tuple_find(const Halcon::HTuple &T1, const Halcon::HTuple &T2, Halcon::HTuple *Indices);
LIntExport Herror tuple_find(const Halcon::HTuple &T1, const Halcon::HTuple &T2, Hlong *Indices);
...
LIntExport Herror tuple_split(const Halcon::HTuple &T1, const Halcon::HTuple &T2, Halcon::HTuple *Splitted);
LIntExport Herror tuple_split(const Halcon::HTuple &T1, const Halcon::HTuple &T2, char *Splitted);
LIntExport Herror tuple_split(const char *T1, const char *T2, Halcon::HTuple *Splitted);
LIntExport Herror tuple_split(const char *T1, const char *T2, char *Splitted);
LIntExport Herror tuple_str_last_n(const Halcon::HTuple &T1, const Halcon::HTuple &T2, Halcon::HTuple *Substring);
LIntExport Herror tuple_str_last_n(const Halcon::HTuple &T1, const Halcon::HTuple &T2, char *Substring);
LIntExport Herror tuple_str_first_n(const Halcon::HTuple &T1, const Halcon::HTuple &T2, Halcon::HTuple *Substring);
LIntExport Herror tuple_str_first_n(const Halcon::HTuple &T1, const Halcon::HTuple &T2, char *Substring);
LIntExport Herror tuple_strrchr(const Halcon::HTuple &T1, const Halcon::HTuple &T2, Halcon::HTuple *Position);
LIntExport Herror tuple_strrchr(const Halcon::HTuple &T1, const Halcon::HTuple &T2, Hlong *Position);
LIntExport Herror tuple_strrchr(const char *T1, const char *T2, Halcon::HTuple *Position);
LIntExport Herror tuple_strrchr(const char *T1, const char *T2, Hlong *Position);
LIntExport Herror tuple_strchr(const Halcon::HTuple &T1, const Halcon::HTuple &T2, Halcon::HTuple *Position);
LIntExport Herror tuple_strchr(const Halcon::HTuple &T1, const Halcon::HTuple &T2, Hlong *Position);
LIntExport Herror tuple_strchr(const char *T1, const char *T2, Halcon::HTuple *Position);
LIntExport Herror tuple_strchr(const char *T1, const char *T2, Hlong *Position);
LIntExport Herror tuple_strrstr(const Halcon::HTuple &T1, const Halcon::HTuple &T2, Halcon::HTuple *Position);
LIntExport Herror tuple_strrstr(const Halcon::HTuple &T1, const Halcon::HTuple &T2, Hlong *Position);
LIntExport Herror tuple_strrstr(const char *T1, const char *T2, Halcon::HTuple *Position);
LIntExport Herror tuple_strrstr(const char *T1, const char *T2, Hlong *Position);
LIntExport Herror tuple_strstr(const Halcon::HTuple &T1, const Halcon::HTuple &T2, Halcon::HTuple *Position);
LIntExport Herror tuple_strstr(const Halcon::HTuple &T1, const Halcon::HTuple &T2, Hlong *Position);
LIntExport Herror tuple_strstr(const char *T1, const char *T2, Halcon::HTuple *Position);
