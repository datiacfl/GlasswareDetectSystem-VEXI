...
LIntExport Herror T_find_calib_descriptor_model(const Hobject Image, const Htuple ModelID, const Htuple DetectorParamName, const Htuple DetectorParamValue, const Htuple DescriptorParamName, const Htuple DescriptorParamValue, const Htuple Seed, const Htuple MinScore, const Htuple NumMatches, const Htuple CamParam, const Htuple ScoreType, Htuple *Pose, Htuple *Score);
LIntExport Herror T_find_uncalib_descriptor_model(const Hobject Image, const Htuple ModelID, const Htuple DetectorParamName, const Htuple DetectorParamValue, const Htuple DescriptorParamName, const Htuple DescriptorParamValue, const Htuple Seed, const Htuple MinScore, const Htuple NumMatches, const Htuple ScoreType, Htuple *HomMat2D, Htuple *Score);
...
LIntExport Herror T_clear_color_trans_lut(const Htuple LUTHandle);
LIntExport Herror clear_color_trans_lut(Hlong LUTHandle);
LIntExport Herror T_apply_color_trans_lut(const Hobject Image1, const Hobject Image2, const Hobject Image3, Hobject *ImageResult1, Hobject *ImageResult2, Hobject *ImageResult3, const Htuple LUTHandle);
LIntExport Herror apply_color_trans_lut(const Hobject Image1, const Hobject Image2, const Hobject Image3, Hobject *ImageResult1, Hobject *ImageResult2, Hobject *ImageResult3, Hlong LUTHandle);
LIntExport Herror T_create_color_trans_lut(const Htuple ColorSpace, const Htuple TransDirection, const Htuple NumBits, Htuple *LUTHandle);
...
LIntExport Herror T_lines_gauss(const Hobject Image, Hobject *Lines, const Htuple Sigma, const Htuple Low, const Htuple High, const Htuple LightDark, const Htuple ExtractWidth, const Htuple CorrectPositions, const Htuple CompleteJunctions);
LIntExport Herror lines_gauss(const Hobject Image, Hobject *Lines, double Sigma, double Low, double High, const char *LightDark, const char *ExtractWidth, const char *CorrectPositions, const char *CompleteJunctions);
...
LIntExport Herror T_get_lut_gamma(Htuple *Gamma);
LIntExport Herror get_lut_gamma(double *Gamma);
LIntExport Herror T_set_lut_gamma(const Htuple Gamma);
LIntExport Herror set_lut_gamma(double Gamma);
...
LIntExport Herror T_gen_grid_rectification_map(const Hobject Image, const Hobject ConnectingLines, Hobject *Map, Hobject *Meshes, const Htuple GridSpacing, const Htuple Rotation, const Htuple Row, const Htuple Col);
LIntExport Herror T_gen_arbitrary_distortion_map(Hobject *Map, const Htuple GridSpacing, const Htuple Row, const Htuple Col, const Htuple GridWidth, const Htuple ImageWidth, const Htuple ImageHeight);
LIntExport Herror T_def_obj(const Hobject Source, const Hobject Prototype, Hobject *Result, const Htuple GreyComponentInputPrototype, const Htuple GreyComponentResult);
LIntExport Herror def_obj(const Hobject Source, const Hobject Prototype, Hobject *Result, Hlong GreyComponentInputPrototype, Hlong GreyComponentResult);
...
LIntExport Herror T_vector_to_pose(const Htuple WorldX, const Htuple WorldY, const Htuple WorldZ, const Htuple ImageRow, const Htuple ImageColumn, const Htuple CamParam, const Htuple Method, const Htuple QualityType, Htuple *Pose, Htuple *Quality);
...
LIntExport Herror T_radial_distortion_self_calibration(const Hobject Contours, Hobject *SelectedContours, const Htuple Width, const Htuple Height, const Htuple InlierThreshold, const Htuple RandSeed, const Htuple DistortionModel, const Htuple DistortionCenter, const Htuple PrincipalPointVar, Htuple *CamParam);
LIntExport Herror T_cam_par_to_cam_mat(const Htuple CamParam, Htuple *CameraMatrix, Htuple *ImageWidth, Htuple *ImageHeight);
LIntExport Herror T_cam_mat_to_cam_par(const Htuple CameraMatrix, const Htuple Kappa, const Htuple ImageWidth, const Htuple ImageHeight, Htuple *CamParam);
...
LIntExport Herror T_get_rectangle_pose(const Hobject Contour, const Htuple CamParam, const Htuple Width, const Htuple Height, const Htuple WeightingMode, const Htuple ClippingFactor, Htuple *Pose, Htuple *CovPose, Htuple *Error);
LIntExport Herror T_get_circle_pose(const Hobject Contour, const Htuple CamParam, const Htuple Radius, const Htuple OutputType, Htuple *Pose1, Htuple *Pose2);
...
LIntExport Herror T_gen_radial_distortion_map(Hobject *Map, const Htuple CamParamIn, const Htuple CamParamOut, const Htuple Interpolation);
LIntExport Herror T_gen_image_to_world_plane_map(Hobject *Map, const Htuple CamParam, const Htuple WorldPose, const Htuple WidthIn, const Htuple HeightIn, const Htuple WidthMapped, const Htuple HeightMapped, const Htuple Scale, const Htuple Interpolation);
LIntExport Herror T_image_to_world_plane(const Hobject Image, Hobject *ImageWorld, const Htuple CamParam, const Htuple WorldPose, const Htuple Width, const Htuple Height, const Htuple Scale, const Htuple Interpolation);
LIntExport Herror T_contour_to_world_plane_xld(const Hobject Contours, Hobject *ContoursTrans, const Htuple CamParam, const Htuple WorldPose, const Htuple Scale);
LIntExport Herror T_image_points_to_world_plane(const Htuple CamParam, const Htuple WorldPose, const Htuple Rows, const Htuple Cols, const Htuple Scale, Htuple *X, Htuple *Y);
...
LIntExport Herror T_hand_eye_calibration(const Htuple X, const Htuple Y, const Htuple Z, const Htuple Row, const Htuple Col, const Htuple NumPoints, const Htuple RobotPose, const Htuple CamParam, const Htuple Method, const Htuple QualityType, Htuple *CameraPose, Htuple *CalibrationPose, Htuple *Quality);
...
LIntExport Herror T_get_line_of_sight(const Htuple Row, const Htuple Column, const Htuple CamParam, Htuple *PX, Htuple *PY, Htuple *PZ, Htuple *QX, Htuple *QY, Htuple *QZ);
LIntExport Herror T_project_3d_point(const Htuple X, const Htuple Y, const Htuple Z, const Htuple CamParam, Htuple *Row, Htuple *Column);
...
LIntExport Herror T_read_cam_par(const Htuple CamParFile, Htuple *CamParam);
LIntExport Herror T_write_cam_par(const Htuple CamParam, const Htuple CamParFile);
LIntExport Herror T_sim_caltab(Hobject *SimImage, const Htuple CalTabDescrFile, const Htuple CamParam, const Htuple CaltabPose, const Htuple GrayBackground, const Htuple GrayCaltab, const Htuple GrayMarks, const Htuple ScaleFac);
LIntExport Herror T_disp_caltab(const Htuple WindowHandle, const Htuple CalTabDescrFile, const Htuple CamParam, const Htuple CaltabPose, const Htuple ScaleFac);
LIntExport Herror T_camera_calibration(const Htuple NX, const Htuple NY, const Htuple NZ, const Htuple NRow, const Htuple NCol, const Htuple StartCamParam, const Htuple NStartPose, const Htuple EstimateParams, Htuple *CamParam, Htuple *NFinalPose, Htuple *Errors);
...
LIntExport Herror T_get_object_model_3d_params(const Htuple ObjectModel3DID, const Htuple GenParamNames, Htuple *GenParamValues);
LIntExport Herror get_object_model_3d_params(Hlong ObjectModel3DID, const char *GenParamNames, char *GenParamValues);
LIntExport Herror T_project_object_model_3d(Hobject *ModelContours, const Htuple ObjectModel3DID, const Htuple CamParam, const Htuple Pose, const Htuple HiddenSurfaceRemoval, const Htuple MinFaceAngle);
...
LIntExport Herror T_open_socket_connect(const Htuple HostName, const Htuple Port, Htuple *Socket);
LIntExport Herror open_socket_connect(const char *HostName, Hlong Port, Hlong *Socket);
LIntExport Herror T_open_socket_accept(const Htuple Port, Htuple *AcceptingSocket);
...
LIntExport Herror T_tuple_split(const Htuple T1, const Htuple T2, Htuple *Splitted);
...
LIntExport Herror T_disp_info(const Htuple ProcName, const Htuple Machine, const Htuple DispProgram, const Htuple Extension);
LIntExport Herror disp_info(const char *ProcName, const char *Machine, const char *DispProgram, const char *Extension);
