 ...
 * Description: frame grabber integration interface (includes)
 *
...
#define FG_INTERFACE_VERSION 2
#define FG_NUM_RESERVED      20

#define FG_MAX_NUM  64   /* max. number of different frame grabber (classes) */
#define FG_MAX_INST 32   /* max. number of handles (instances) per class     */
