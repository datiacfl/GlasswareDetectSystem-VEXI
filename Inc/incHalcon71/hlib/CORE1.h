...
extern HLibExport Herror HPGetPar(Hproc_handle proc_handle,
		  INT par_num, INT kind_in, INT *kind, Hpar Val[],
...
extern HLibExport Herror HPGetCPar(Hproc_handle proc_handle,
		         INT par_num, INT kind_in, Hcpar Val[], INT4_8 min,
...
extern HLibExport Herror HPPutPar(Hproc_handle proc_handle,
		        INT par_num, INT kind, Hpar *Val, INT4_8 num);
...
/* HPPutRL - store region as object, put it into output par., return its key */
extern HLibExport Herror HPPutRL(Hproc_handle proc_handle, Hrlregion *region, Hkey *key);

/* HPPutDRL - store region as object and return its object key               */
...
/* HPNewRegion - create new output object with defined region               */
