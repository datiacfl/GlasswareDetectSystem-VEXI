...
public:
  HImage(void) :     HObject(),init(FALSE),privat(FALSE),
    width(0),height(0),type(0),ptr(0) {num_images++;}
  ...
  HImage(void *ptr, void *ptrfreecall, int loc_width, int loc_height,
	 const char *type);
  virtual ~HImage(void) {num_images--;}
...
protected:
  ...
  void   Init(void);      // width, height zur Verfuegung stellen
  void   Private(void);   // Private Matrix erzwingen
  HBool  init;            // Init() wurde ausgefuehrt
  HBool  privat;          // Init() und Private() wurden ausgefuehrt
  int    word_length;     // 1,2 oder 4, je nach type
  int    width, height;   // Bildgroesse; gesetzt durch Init()
  int    type;            // Halcon-Pixeltyp fuer switch
  char   type_str[20];    // Halcon-Pixeltyp als String
  void   *ptr;            // Zeiger auf Matrix; gesetzt durch Private()
  void   SetInitial(void);// Ruecksetzen fuer Konstruktoren etc.
private:
...
public:
  ...
  static HImage GrabImageAsync(const Halcon::HTuple &FGHandle, const Halcon::HTuple &MaxDelay);
  static HImage GrabImageAsync(Hlong FGHandle, double MaxDelay);
  // Grab an image from the specified frame grabber.
  static HImage GrabImage(const Halcon::HTuple &FGHandle);
  static HImage GrabImage(Hlong FGHandle);
  ...
  virtual HImage ProjectiveTransImageSize(double HomMat2D, const char *Interpolation, Hlong Width, Hlong Height, const char *TransformRegion) const;
  ...
  virtual HImage ProjectiveTransImage(double HomMat2D, const char *Interpolation, const char *AdaptImageSize, const char *TransformRegion) const;
  ...
  virtual HImage AffineTransImageSize(double HomMat2D, const char *Interpolation, Hlong Width, Hlong Height) const;
  ...
  virtual HImage AffineTransImage(double HomMat2D, const char *Interpolation, const char *AdaptImageSize) const;
  ...
  virtual HTuple DvfToHomMat2d(void) const;
  ...
  virtual HImage Laplace(const Halcon::HTuple &FilterType, const Halcon::HTuple &Size, const Halcon::HTuple &NeighbourhoodType) const;
  virtual HImage Laplace(const char *FilterType, Hlong Size, const char *NeighbourhoodType) const;
  ...
  virtual HImage OpticalFlowMatch(const HImage &Image2, const Halcon::HTuple &Mode, const Halcon::HTuple &Threshold, const Halcon::HTuple &Step, const Halcon::HTuple &SizeWindow, const Halcon::HTuple &SizeSearch, const Halcon::HTuple &Weights) const;
  virtual HImage OpticalFlowMatch(const HImage &Image2, const char *Mode, Hlong Threshold, Hlong Step, Hlong SizeWindow, Hlong SizeSearch, Hlong Weights) const;
  virtual HImage OpticalFlowMatch(const HImageArray &Image2, const Halcon::HTuple &Mode, const Halcon::HTuple &Threshold, const Halcon::HTuple &Step, const Halcon::HTuple &SizeWindow, const Halcon::HTuple &SizeSearch, const Halcon::HTuple &Weights) const;
  virtual HImage OpticalFlowMatch(const HImageArray &Image2, const char *Mode, Hlong Threshold, Hlong Step, Hlong SizeWindow, Hlong SizeSearch, Hlong Weights) const;
  ...
  virtual HImage FillDvf(const Halcon::HTuple &Width, const Halcon::HTuple &Height, const Halcon::HTuple &Iterations) const;
  virtual HImage FillDvf(Hlong Width, Hlong Height, Hlong Iterations) const;
  ...
  virtual HImage AddNoiseDistribution(double Distribution) const;
  ...
  virtual HImage LutTrans(Hlong Lut) const;
  ...
  virtual HImage Int1ToDvf(const HImage &Col) const;
  virtual HImage Int1ToDvf(const HImageArray &Col) const;
  // Convert a displacement vector field into two int1-images.
  virtual HImage DvfToInt1(HImage *Col) const;
  ...
  virtual HXLDArray ConnectGridPoints(double Row, double Col, Hlong Sigma, double MaxDist) const;
  ...
  static HImage GenRadialDistortionMap(double CamParIn, double CamParOut, const char *Interpolation);
  ...
  virtual HImage ChangeRadialDistortionImage(const HRegion &Region, double CamParIn, double CamParOut) const;
  ...
  static HImage SimCaltab(const char *CalTabDescrFile, double CamParam, double CaltabPose, Hlong GrayBackground, Hlong GrayCaltab, Hlong GrayMarks, double ScaleFac);
  ...
  virtual HTuple FindMarksAndPose(const HRegion &CalTabRegion, const char *CalTabDescrFile, double StartCamParam, Hlong StartThresh, Hlong DeltaThresh, Hlong MinThresh, double Alpha, double MinContLength, double MaxDiamMarks, Halcon::HTuple *CCoord, Halcon::HTuple *StartPose) const;
  ...
  virtual HImage PhotStereo(double Slants, double Tilts) const;
  ...
  static HImage GenBinocularProjRectification(HImage *Map2, double FMatrix, double CovFMat, Hlong Width1, Hlong Height1, Hlong Width2, Hlong Height2, Hlong SubSampling, const char *Mapping, Halcon::HTuple *CovFMatRect, Halcon::HTuple *H1, Halcon::HTuple *H2);
  ...
  virtual HTuple MatchRelPoseRansac(const HImage &Image2, double Rows1, double Cols1, double Rows2, double Cols2, double CamPar1, double CamPar2, const char *GrayMatchMethod, Hlong MaskSize, Hlong RowMove, Hlong ColMove, Hlong RowTolerance, Hlong ColTolerance, double Rotation, Hlong MatchThreshold, const char *EstimationMethod, double DistanceThreshold, Hlong RandSeed, Halcon::HTuple *CovRelPose, Halcon::HTuple *Error, Halcon::HTuple *Points1, Halcon::HTuple *Points2) const;
  ...
  virtual HTuple MatchEssentialMatrixRansac(const HImage &Image2, double Rows1, double Cols1, double Rows2, double Cols2, double CamMat1, double CamMat2, const char *GrayMatchMethod, Hlong MaskSize, Hlong RowMove, Hlong ColMove, Hlong RowTolerance, Hlong ColTolerance, double Rotation, Hlong MatchThreshold, const char *EstimationMethod, double DistanceThreshold, Hlong RandSeed, Halcon::HTuple *CovEMat, Halcon::HTuple *Error, Halcon::HTuple *Points1, Halcon::HTuple *Points2) const;
  // 
  ...
  virtual HTuple MatchFundamentalMatrixRansac(const HImage &Image2, double Rows1, double Cols1, double Rows2, double Cols2, const char *GrayMatchMethod, Hlong MaskSize, Hlong RowMove, Hlong ColMove, Hlong RowTolerance, Hlong ColTolerance, double Rotation, Hlong MatchThreshold, const char *EstimationMethod, double DistanceThreshold, Hlong RandSeed, Halcon::HTuple *CovFMat, Halcon::HTuple *Error, Halcon::HTuple *Points1, Halcon::HTuple *Points2) const;
  ...
  virtual HImage BinocularDistance(const HImage &Image2, HImage *Score, double CamParamRect1, double CamParamRect2, double RelPoseRect, const char *Method, Hlong MaskWidth, Hlong MaskHeight, double TextureThresh, double MinDisparity, double MaxDisparity, Hlong NumLevels, double ScoreThresh, const char *Filter, const char *SubDistance) const;
  ...
  static HImage GenBinocularRectificationMap(HImage *Map2, double CamParam1, double CamParam2, double RelPose, double SubSampling, const char *Method, const char *Interpolation, Halcon::HTuple *CamParamRect1, Halcon::HTuple *CamParamRect2, Halcon::HTuple *CamPoseRect1, Halcon::HTuple *CamPoseRect2, Halcon::HTuple *RelPoseRect);
  ...
  virtual HTuple ProjMatchPointsRansac(const HImage &Image2, double Rows1, double Cols1, double Rows2, double Cols2, const char *GrayMatchMethod, Hlong MaskSize, Hlong RowMove, Hlong ColMove, Hlong RowTolerance, Hlong ColTolerance, double Rotation, Hlong MatchThreshold, const char *EstimationMethod, double DistanceThreshold, Hlong RandSeed, Halcon::HTuple *Points1, Halcon::HTuple *Points2) const;
