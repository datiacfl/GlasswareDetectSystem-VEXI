...
public:
  ...
  // Class Functions
  static Hlong NumInst(void) {return num_cont;}

private:
  static Hlong num_cont;

public:
  // Interactive modifikation of a contour.
  ...
  virtual HXLDCont ChangeRadialDistortionContoursXld(double CamParIn, double CamParOut) const;
  // Test XLD contours for self intersection.
  virtual Hlong TestSelfIntersectionXld(const Halcon::HTuple &CloseContours) const;
  virtual Hlong TestSelfIntersectionXld(const char *CloseContours) const;
  ...
  virtual HXLDCont ProjectiveTransContourXld(double HomMat2D) const;
  ...
  virtual HXLDCont AffineTransContourXld(double HomMat2D) const;
  ...
  static HXLDCont GenContourPolygonRoundedXld(double Row, double Col, double Radius, double SamplingInterval);
  ...
  static HXLDCont GenContourPolygonXld(double Row, double Col);
};
