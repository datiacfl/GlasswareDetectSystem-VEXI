...
public:
  HImageArray(void) : array(NULL) {num_image_arrays++;}
  ...
  // Klassenoperationen
  static Hlong NumInst(void) { return num_image_arrays; }
private:
  static Hlong num_image_arrays;
  HImage  *array;
...
public:
  ...
  virtual HImage GenSphericalMosaic(const Halcon::HTuple &CameraMatrices, const Halcon::HTuple &RotationMatrices, const Halcon::HTuple &LatMin, const Halcon::HTuple &LatMax, const Halcon::HTuple &LongMin, const Halcon::HTuple &LongMax, const Halcon::HTuple &LatLongStep, const Halcon::HTuple &StackingOrder) const;
  ...
  virtual HImageArray ProjectiveTransImageSize(double HomMat2D, const char *Interpolation, Hlong Width, Hlong Height, const char *TransformRegion) const;
  ...
  virtual HImageArray ProjectiveTransImage(double HomMat2D, const char *Interpolation, const char *AdaptImageSize, const char *TransformRegion) const;
  ...
  virtual HImageArray AffineTransImageSize(double HomMat2D, const char *Interpolation, Hlong Width, Hlong Height) const;
  ...
  virtual HImageArray AffineTransImage(double HomMat2D, const char *Interpolation, const char *AdaptImageSize) const;
  ...
  virtual HImageArray Laplace(const Halcon::HTuple &FilterType, const Halcon::HTuple &Size, const Halcon::HTuple &NeighbourhoodType) const;
  virtual HImageArray Laplace(const char *FilterType, Hlong Size, const char *NeighbourhoodType) const;
  ...
  virtual HImageArray OpticalFlowMatch(const HImageArray &Image2, const Halcon::HTuple &Mode, const Halcon::HTuple &Threshold, const Halcon::HTuple &Step, const Halcon::HTuple &SizeWindow, const Halcon::HTuple &SizeSearch, const Halcon::HTuple &Weights) const;
  virtual HImageArray OpticalFlowMatch(const HImageArray &Image2, const char *Mode, Hlong Threshold, Hlong Step, Hlong SizeWindow, Hlong SizeSearch, Hlong Weights) const;
  ...
  virtual HImageArray FillDvf(const Halcon::HTuple &Width, const Halcon::HTuple &Height, const Halcon::HTuple &Iterations) const;
  virtual HImageArray FillDvf(Hlong Width, Hlong Height, Hlong Iterations) const;
  ...
  virtual HImageArray AddNoiseDistribution(double Distribution) const;
  ...
  virtual HImageArray LutTrans(Hlong Lut) const;
  ...
  virtual HImageArray Int1ToDvf(const HImageArray &Col) const;
  virtual HImageArray DvfToInt1(HImageArray *Col) const;
  ...
  virtual HImageArray ChangeRadialDistortionImage(const HRegion &Region, double CamParIn, double CamParOut) const;
  ...
  static HImageArray GenBinocularProjRectification(HImageArray *Map2, double FMatrix, double CovFMat, Hlong Width1, Hlong Height1, Hlong Width2, Hlong Height2, Hlong SubSampling, const char *Mapping, Halcon::HTuple *CovFMatRect, Halcon::HTuple *H1, Halcon::HTuple *H2);
