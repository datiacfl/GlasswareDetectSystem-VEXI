...
public:
  ...
  HXLDArray(Hlong n) : HObjectArray(n), array(NULL) {}
...
public:
  virtual HTuple GetRectanglePose(const Halcon::HTuple &CamParam, const Halcon::HTuple &Width, const Halcon::HTuple &Height, const Halcon::HTuple &WeigthingMode, const Halcon::HTuple &ClippingFactor, Halcon::HTuple *CovPose, Halcon::HTuple *Error) const;
