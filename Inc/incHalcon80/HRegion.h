...
public:
  ...
  virtual HTuple DoOcrWordSvm(const HImage &Image, const Halcon::HTuple &OCRHandle, const Halcon::HTuple &Expression, const Halcon::HTuple &NumAlternatives, const Halcon::HTuple &NumCorrections, char *Word, double *Score) const;
  virtual HTuple DoOcrWordSvm(const HImage &Image, Hlong OCRHandle, const char *Expression, Hlong NumAlternatives, Hlong NumCorrections, char *Word, double *Score) const;
  ...
  virtual HTuple DoOcrSingleClassSvm(const HImage &Image, const Halcon::HTuple &OCRHandle, const Halcon::HTuple &Num) const;
  // Classify a related group of characters with an OCR classifier.
  virtual HTuple DoOcrWordMlp(const HImage &Image, const Halcon::HTuple &OCRHandle, const Halcon::HTuple &Expression, const Halcon::HTuple &NumAlternatives, const Halcon::HTuple &NumCorrections, double *Confidence, char *Word, double *Score) const;
  virtual HTuple DoOcrWordMlp(const HImage &Image, Hlong OCRHandle, const char *Expression, Hlong NumAlternatives, Hlong NumCorrections, double *Confidence, char *Word, double *Score) const;
  // Classify multiple characters with an OCR classifier.
  virtual HTuple DoOcrMultiClassMlp(const HImage &Image, const Halcon::HTuple &OCRHandle, double *Confidence) const;
  virtual HTuple DoOcrMultiClassMlp(const HImage &Image, Hlong OCRHandle, double *Confidence) const;
  // Classify a single character with an OCR classifier.
  virtual HTuple DoOcrSingleClassMlp(const HImage &Image, const Halcon::HTuple &OCRHandle, const Halcon::HTuple &Num, Halcon::HTuple *Confidence) const;
