...
typedef struct DB_HANDLE {
  ...
  H_pthread_mutex_t mutex_RegionCount;           /* lock writing to reference*/
  H_pthread_mutex_t mutex_ImageCount;            /* counter on primary iconic*/
  H_pthread_mutex_t mutex_XLDCount;              /* objects                  */
