...
public:
  ...
  virtual void PrepareDirectVariationModel(const HImageArray &RefImage, const HImage &VarImage, const Halcon::HTuple &AbsThreshold, const Halcon::HTuple &VarThreshold) const;
  virtual void PrepareDirectVariationModel(const HImageArray &RefImage, const HImage &VarImage, double AbsThreshold, double VarThreshold) const;
  // Prepare a variation model for comparison with an image.
