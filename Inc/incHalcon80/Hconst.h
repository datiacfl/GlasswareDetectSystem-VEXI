...
#define H_ERR_GMM_TRAIN_FEWSAMPLES 3338 /* Too few samples for at least one class */
...
#define PROG_LANGUAGE_DOTNET      "dotnet"
...
#define DEF_LANG_INT_ID           PROG_LANGUAGE_HDEVELOP   /* Default lang.  */
