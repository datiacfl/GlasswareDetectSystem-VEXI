...
public:
  ...
  virtual HTuple ComposeFunct1d(const Halcon::HTuple &Function2, const Halcon::HTuple &Border);
  // Calculate the inverse of a function.
  virtual HTuple InvertFunct1d();
  // Calculate the derivatives of a function.
  virtual HTuple DerivateFunct1d(const Halcon::HTuple &Mode);
  ...
  virtual HTuple ScaleYFunct1d(const Halcon::HTuple &Mult, const Halcon::HTuple &Add);
  // Negation of the y values.
  virtual HTuple NegateFunct1d();
  // Absolute value of the y values.
  virtual HTuple AbsFunct1d();
  ...
  virtual HTuple SampleFunct1d(const Halcon::HTuple &XMin, const Halcon::HTuple &XMax, const Halcon::HTuple &XDist, const Halcon::HTuple &Border);
  // Transform a function using given transformation parameters.
  virtual HTuple TransformFunct1d(const Halcon::HTuple &Params);
  ...
  virtual HTuple SmoothFunct1dGauss(const Halcon::HTuple &Sigma);
  ...
  virtual HTuple SmoothFunct1dMean(const Halcon::HTuple &SmoothSize, const Halcon::HTuple &Iterations);
  // Plot a function using gnuplot.
  virtual void GnuplotPlotFunct1d(const Halcon::HTuple &GnuplotFileID) const;
};
