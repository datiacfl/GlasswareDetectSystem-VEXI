...
class LIntExport HComponentModel: public HRootObject {
public:
  HComponentModel(void) {id = -1;}
  HComponentModel(
  ...
  ~HComponentModel(void);
private:
  // Copying and Assignment not allowed
  HComponentModel(const HComponentModel &inst);
  HComponentModel &operator= (const HComponentModel &inst);
  // Internal Cleanup
  void Cleanup(void);

public: 
  // Tools
  const char *ClassName(void) const {return "HComponentModel";}
...
public:
  ...
  virtual HTuple CreateTrainedComponentModel(const Halcon::HTuple &ComponentTrainingID, const Halcon::HTuple &AngleStart, const Halcon::HTuple &AngleExtent, const Halcon::HTuple &MinContrastComp, const Halcon::HTuple &MinScoreComp, const Halcon::HTuple &NumLevelsComp, const Halcon::HTuple &AngleStepComp, const Halcon::HTuple &OptimizationComp, const Halcon::HTuple &MetricComp, const Halcon::HTuple &PregenerationComp);
  virtual HTuple CreateTrainedComponentModel(Hlong ComponentTrainingID, double AngleStart, double AngleExtent, Hlong MinContrastComp, double MinScoreComp, Hlong NumLevelsComp, double AngleStepComp, const char *OptimizationComp, const char *MetricComp, const char *PregenerationComp);
};
